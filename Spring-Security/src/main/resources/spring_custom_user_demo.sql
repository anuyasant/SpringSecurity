DROP DATABASE  IF EXISTS `spring_custom_user_demo`;

CREATE DATABASE  IF NOT EXISTS `spring_custom_user_demo`;
USE `spring_custom_user_demo`;
...
VALUES 
('ROLE_EMPLOYEE'),('ROLE_CLIENT'),('ROLE_ADMIN');
